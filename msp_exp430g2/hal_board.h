...
#define     POWER_DIR      P4DIR
#define     POWER_OUT      P4OUT
#define     POWER_EN       BIT2
  
#define     VCC_TC_DIR     P4DIR
#define     VCC_TC_OUT     P4OUT
#define     VCC_TC_EN      BIT1
  
#define     VCC_A_dIR      P4DIR
#define     VCC_A_OUT      P4OUT
#define     VCC_A_EN       BIT0
  
#define     TC_RST_dIR      P1DIR
